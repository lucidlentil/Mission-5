        ...
        <div>
            ...
            <div className="library-container">
                 <div className="directory">
                    <span className="home">Home </span>&gt;<span className="home"> Computers & Tablets </span>&gt;<Link to="/" className="parent"> Laptops </Link>&gt;<Link to="/browse/all" className="parent"> All </Link>&gt;<span className="child"> Home & Study</span>
                </div>
